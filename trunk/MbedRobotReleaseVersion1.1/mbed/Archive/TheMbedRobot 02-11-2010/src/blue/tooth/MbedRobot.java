...
public class MbedRobot extends Activity implements SensorEventListener {
	...
	float startThreshold = (float) 0.1;  

	// Change these values to create the range of movement you want to use on the phone.
	float pitchRange = 80; // Set the no. of degrees of max speed for going forwards
	float rollRange = 120;  // Set the no. of degrees of max speed for spinning
